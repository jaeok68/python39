...
def swap2(nums):
    ...
    nums[0] = nums[1]
    nums[1] = c
    print('swap 내부', nums[0], nums[1],  id(nums[0]), id(nums[1]))


nums = [3, 5]
print('호출전', nums[0], nums[1],  id(nums[0]), id(nums[1])  )
swap2(nums)
print('호출후', nums[0], nums[1],  id(nums[0]), id(nums[1])  )
